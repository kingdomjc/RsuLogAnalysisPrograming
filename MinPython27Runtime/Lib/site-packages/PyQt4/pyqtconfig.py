...
_pkg_config = {
    'pyqt_bin_dir':      'C:\\Python27\\Lib\\site-packages\\PyQt4\\bin',
    'pyqt_config_args':  '--confirm-license -b C:\\Python27\\Lib\\site-packages\\PyQt4\\bin',
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_Accessibility -x PyQt_NoPrintRangeBug -t Qt_4_7_1 -x Py_v3 -g',
    'pyqt_version':      0x040803,
    'pyqt_version_str':  '4.8.3',
    'qt_data_dir':       'C:\\Qt\\4.7.1',
    'qt_dir':            'C:\\Qt\\4.7.1',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Qt\\4.7.1\\include',
    'qt_lib_dir':        'C:\\Qt\\4.7.1\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040701,
    'qt_winconfig':      'shared'
}
